...
<h3 style="text-align:center;">为该用户分配角色</h3>
      
        <div class="container">
    <div class="row">
        <div class="col-md-offset-3 col-md-6">
            <form class="form-horizontal" action="/MyGraduate/user_role/addUser_role" method="post">
                ...
                <div class="form-group help">
                    <input type="text" class="form-control" id="inputPassword3" name="roleid" placeholder=分配角色编号为(请查看角色表填写角色编号)>
